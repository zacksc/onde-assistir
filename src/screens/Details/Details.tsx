...
import { getMovieDetails, saveToHistory, addToFavorites, removeFromFavorites, getFavorites } from '../../services/tmdb'
import { fetchStreamingProviders } from '../../viewmodels/streamingViewModel'
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        ...
        const provs = await fetchStreamingProviders(movieId)
        setProviders(provs)
        await saveToHistory({
          id: movieDetails.id,
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        />
        <StreamingCard providers={providers} />
      </View>
    </ScrollView>
  )
}
